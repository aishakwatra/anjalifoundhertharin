    ...
    <section className="bg-sage pb-12 md:pb-24 text-center">
      <div className="px-6 pt-7 pb-5 md:pt-16 md:pb-12">
        <div className="mb-5 md:mb-10 flex justify-center gap-5 md:gap-12">
          <div className="relative w-[200px] h-[200px] opacity-75">
            <Image 
              src="/photos/ganesh.png" 
              alt="Ganesh" 
              fill 
              sizes="200px" // Matched to container width
        ...
        {/* Updated Title: Replaced text with image as requested previously */}
        <div className="relative mx-auto mb-8 w-[70vw] md:w-[50vw] max-w-[600px] h-[100px] md:h-[180px]">
          <Image 
    ...
    <div className="relative flex items-start gap-5">
      ...
      <div className="w-14 h-14 flex-shrink-0 pt-0.5 relative">
        <Image 
          ...
          alt="" 
          fill 
          sizes="56px" // Added sizes prop for timeline icons
